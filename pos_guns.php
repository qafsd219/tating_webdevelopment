            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="row">
                    <script>
                        ...
                        const gun_prices = [2000, 3000, 2700, 3100, 500, 500, 1700, 2300, 1900, 300, 2500, 2200, 300, 4500, 4500, 3900, 800, 2100, 700, 500];
                        for (let i = 0; i < guns.length; i++) {
                            const gunName = guns[i];
                            const price = gun_prices[i];
                            document.write(`
                                <div class="col-md-3">
                                    <div>
                                        <img src='uploads/gun_pics/${i + 1}.jpg' data-toggle="tooltip" data-placement="center" title="${gunName}+" width="240px" height="150px" alt="${gunName}">
                                        <div>
                                            <input type="checkbox" name="check_${i + 1}" id="check_${i + 1}" onclick="handleItems('${gunName}', '${price}')" class="checkbox-group">
                                            <label for="check_${i + 1}">${gunName}(<b>₱ ${price}</b>)</label>
                                        </div>
                                    </div>
                                </div>
                            `);
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <ul class="list-group list-group-horizontal gap-5">
                            ...
                            <li class="" style="list-style-type: none;"> <input class="form-check-input" type="radio" name="flexRadioDefault" id="discountGund" onclick="handleDiscounts(0.08)" value="discount Gund">
                                <label class="form-check-label" for="flexRadioDefault1">With Disc. Gund (8%)</label>
                            </li>
